    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailingEmail", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailingGroup", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MailingGroup_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    MailingEmailId = table.Column<Guid>(nullable: false),
                    MailingGroupId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailingEmailGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MailingEmailGroups_MailingEmail_MailingEmailId",
                        column: x => x.MailingEmailId,
